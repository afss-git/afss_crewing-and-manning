...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    // Call the external API for rejected contracts
    const externalResponse = await fetch(
      "https://crewing-mvp.onrender.com/api/v1/admin/contracts/status/rejected",
      {
        method: "GET",
        headers: {
    ...
    console.error("Failed to fetch rejected contracts:", err);
